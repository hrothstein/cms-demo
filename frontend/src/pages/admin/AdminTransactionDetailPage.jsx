...
const AdminTransactionDetailPage = () => {
  ...
  const fetchTransaction = async () => {
    try {
      setIsLoading(true);
      const response = await adminApi.getTransaction(transactionId);
      if (response.success) {
        ...
        <div className="flex-1 min-w-0">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              <li>
                <Link to="/admin/transactions" className="text-sm font-medium text-gray-500 hover:text-gray-700">
                  Transactions
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {transaction.merchant_category || transaction.category}
              </dd>
            </div>
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <Link 
                  to={`/admin/cards/${transaction.card_id}`}
